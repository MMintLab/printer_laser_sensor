...
def gradient_descent(weights, red_channel, green_channel, blue_channel, left_red_channel, left_green_channel, left_blue_channel, right_red_channel, right_green_channel, right_blue_channel, incr, learning_rate, output_image):
    ...
    green_cost = compute_cost(get_highest_intensity_pixel_indices(get_weighted_average(weights2, red_channel, green_channel, blue_channel, left_red_channel, left_green_channel, left_blue_channel, right_red_channel, right_green_channel, right_blue_channel)), output_indices)
    blue_cost = compute_cost(get_highest_intensity_pixel_indices(get_weighted_average(weights3, red_channel, green_channel, blue_channel, left_red_channel, left_green_channel, left_blue_channel, right_red_channel, right_green_channel, right_blue_channel)), output_indices)
    left_red_cost = compute_cost(get_highest_intensity_pixel_indices(get_weighted_average(weights4, red_channel, green_channel, blue_channel, left_red_channel, left_green_channel, left_blue_channel, right_red_channel, right_green_channel, right_blue_channel)), output_indices)
    left_green_cost = compute_cost(get_highest_intensity_pixel_indices(get_weighted_average(weights5, red_channel, green_channel, blue_channel, left_red_channel, left_green_channel, left_blue_channel, right_red_channel, right_green_channel, right_blue_channel)), output_indices)
    left_blue_cost = compute_cost(get_highest_intensity_pixel_indices(get_weighted_average(weights6, red_channel, green_channel, blue_channel, left_red_channel, left_green_channel, left_blue_channel, right_red_channel, right_green_channel, right_blue_channel)), output_indices)
    right_red_cost = compute_cost(get_highest_intensity_pixel_indices(get_weighted_average(weights7, red_channel, green_channel, blue_channel, left_red_channel, left_green_channel, left_blue_channel, right_red_channel, right_green_channel, right_blue_channel)), output_indices)
    right_green_cost = compute_cost(get_highest_intensity_pixel_indices(get_weighted_average(weights8, red_channel, green_channel, blue_channel, left_red_channel, left_green_channel, left_blue_channel, right_red_channel, right_green_channel, right_blue_channel)), output_indices)
    right_blue_cost = compute_cost(get_highest_intensity_pixel_indices(get_weighted_average(weights9, red_channel, green_channel, blue_channel, left_red_channel, left_green_channel, left_blue_channel, right_red_channel, right_green_channel, right_blue_channel)), output_indices)
