...
weights[0,0] = -1.18942075
weights[1,0] = 2.44500537
weights[2,0] = -1.3129521
weights[3,0] = 0.92979412
weights[4,0] = -0.64788918

filename_list = get_filename_list(test_number,data_folder)

def save_video_mp4(image_folder, testnumber):
    video_name = 'test%02d_nozzleseg.mp4' % (testnumber)
    ...
    video = cv2.VideoWriter(video_name, fourcc, 10, (width*2,height))
